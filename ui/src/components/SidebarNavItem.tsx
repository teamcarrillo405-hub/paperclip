...
export function SidebarNavItem({
  ...
  return (
    ...
    >
      ...
      {/* Right-side group: badges + favorite toggle — fades with label */}
      <div
        className={cn(
          "ml-auto flex items-center gap-1.5 shrink-0 transition-all duration-150",
      ...
      >
        ...
        {onFavoriteToggle && (
          <button
            ...
            className="opacity-0 group-hover:opacity-100 transition-opacity shrink-0 text-muted-foreground/50 hover:text-foreground p-0.5"
          >
